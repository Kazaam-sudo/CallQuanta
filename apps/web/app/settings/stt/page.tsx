...
export default function Page() {
  ...
  return (
    <main className="grid" style={{ gap: 16 }}>
      <div className="actions"><Link href="/settings/llm">LLM Providers</Link><Link href="/settings/scorecard">Scorecard</Link><Link href="/settings/workspace">Workspace Language</Link><Link href="/settings/stt">STT Providers</Link></div>
